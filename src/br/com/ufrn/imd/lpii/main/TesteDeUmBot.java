...
public class TesteDeUmBot {
    //O  único propósito dessa classe é mostrar o Bot implementado seguindo o tutorial que o professor deixou disponível

    public static void main(String[] args) {
        //criação do objeto bot com as informações de acesso
        TelegramBot bot = TelegramBotAdapter.build("997708373:AAGeiapxOGi2bcyHDB8bjDgQ04t2jobCI4E");
